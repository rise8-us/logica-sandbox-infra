CREATE DATABASE  IF NOT EXISTS `hspc_8_hspc9` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `hspc_8_hspc9`;
-- MySQL dump 10.13  Distrib 8.0.21, for macos10.15 (x86_64)
--
-- Host: sandboxdb.logicahealth.org    Database: hspc_8_hspc9
-- ------------------------------------------------------
...
--
-- Dumping events for database 'hspc_8_hspc9'
--

--
-- Dumping routines for database 'hspc_8_hspc9'
--
/*!50003 DROP PROCEDURE IF EXISTS `DO_MIGRATE_HAPI_37_TO_HAPI_38` */;
...
DELIMITER ;;
CREATE DEFINER=`system`@`%` PROCEDURE `DO_MIGRATE_HAPI_37_TO_HAPI_38`()
BEGIN
  DECLARE done BOOLEAN DEFAULT FALSE;
  DECLARE current_schema_name VARCHAR(255);
  DECLARE cur CURSOR FOR SELECT schema_name FROM information_schema.SCHEMATA WHERE UPPER(schema_name) LIKE 'HSPC_8_9%';
...
/*!50003 DROP PROCEDURE IF EXISTS `MIGRATE_HAPI_37_TO_HAPI_38` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`system`@`%` PROCEDURE `MIGRATE_HAPI_37_TO_HAPI_38`(IN MYSCHEMANAME VARCHAR(255))
BEGIN
...
-- Dump completed on 2021-02-17 17:31:06
